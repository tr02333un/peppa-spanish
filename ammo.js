...
const AMMO_DATA = [
  ...
  },
  {
    ...
    fire_peppa:{es:"Cuando George se va a la cama el señor Dinosaurio se acurruca a su lado.", zh:"當喬治上床睡覺時，恐龍先生就蜷縮在他身旁。", ts:null,
      chunks:[{w:"Cuando",role:"c",hideYg:true},{w:"George",role:"s"},{w:"se va a la cama",role:"v",note:"irse ➔ se va（自己對自己做的動詞）+ a la cama ➔ 意思：去睡覺（irse a = 去做某事）"},{w:"el señor Dinosaurio",role:"s"},{w:"se acurruca",role:"v",note:"acurrucarse ➔ se acurruca ➔ 意思：蜷縮（自己對自己做的動詞，「他/她」）"},{w:"a su lado.",role:"o"}]},
    fire_daily:[
  ...
  },
  {
    ...
    fire_peppa:{es:"El señor Dinosaurio no está en la cama de George.", zh:"恐龍先生不在喬治的床上。", ts:null,
      chunks:[{w:"El señor Dinosaurio",role:"s"},{w:"no está",role:"v",note:"estar ➔ está（「他/她」）+ no ➔ 意思：不在（口訣：SER=本質，ESTAR=位置）"},{w:"en la cama de George.",role:"o"}]},
    fire_daily:[
  ...
  },
  {
    ...
    fire_peppa:{es:"Peppa quiere mucho a Susi y Susi quiere mucho a Peppa.", zh:"佩佩非常喜歡蘇西，蘇西也非常喜歡佩佩。", ts:null,
      chunks:[{w:"Peppa",role:"s"},{w:"quiere mucho",role:"v",note:"querer ➔ quiere（「他/她」）+ mucho（強調）➔ 意思：非常喜歡/愛（人名前必加 a）"},{w:"a Susi",role:"o"},{w:"y",role:"c",hideYg:true},{w:"Susi",role:"s"},{w:"quiere mucho",role:"v",note:"querer ➔ quiere（「他/她」）+ mucho（強調）➔ 意思：非常喜歡/愛（人名前必加 a）"},{w:"a Peppa.",role:"o"}]},
    fire_daily:[
  ...
  },
  {
    ...
    fire_peppa:{es:"A George no le gusta jugar solo.", zh:"喬治不喜歡一個人玩。", ts:null,
      chunks:[{w:"A George",role:"s"},{w:"no le gusta",role:"v",note:"gustar ➔ gusta（「他/她」）+ le（間接受詞（英文的 to him / to her / to them））+ no ➔ 意思：不喜歡（倒裝：A+人+le gusta+動詞）"},{w:"jugar solo.",role:"o"}]},
    fire_daily:[
