...
const SUFFIX_PATTERNS = [
  {
    ...
    words: [
      {en:'nation',      es:'nación',       art:'la', zh:'國家'},
      {en:'action',      es:'acción',       art:'la', zh:'行動'},
      {en:'emotion',     es:'emoción',      art:'la', zh:'情緒'},
      {en:'information', es:'información',  art:'la', zh:'資訊'},
      {en:'education',   es:'educación',    art:'la', zh:'教育'},
      {en:'situation',   es:'situación',    art:'la', zh:'情況'},
    ]
  },
  {
    rule: '-ty → -dad',
    ...
    words: [
      {en:'city',        es:'ciudad',       art:'la', zh:'城市'},
      {en:'reality',     es:'realidad',     art:'la', zh:'現實'},
      {en:'quality',     es:'calidad',      art:'la', zh:'品質'},
      {en:'university',  es:'universidad',  art:'la', zh:'大學'},
      {en:'society',     es:'sociedad',     art:'la', zh:'社會'},
      {en:'liberty',     es:'libertad',     art:'la', zh:'自由'},
    ]
  },
  {
    rule: '-ce / -cy → -cia / -ncia',
    ...
    words: [
      {en:'patience',    es:'paciencia',    art:'la', zh:'耐心'},
      {en:'experience',  es:'experiencia',  art:'la', zh:'經驗'},
      {en:'distance',    es:'distancia',    art:'la', zh:'距離'},
      {en:'importance',  es:'importancia',  art:'la', zh:'重要性'},
      {en:'difference',  es:'diferencia',   art:'la', zh:'差異'},
    ]
  },
  {
    ...
    words: [
      {en:'moment',     es:'momento',      art:'el', zh:'時刻'},
      {en:'movement',   es:'movimiento',   art:'el', zh:'動作／運動'},
      {en:'sentiment',  es:'sentimiento',  art:'el', zh:'情感'},
      {en:'instrument', es:'instrumento',  art:'el', zh:'樂器'},
      {en:'argument',   es:'argumento',    art:'el', zh:'論點'},
    ]
  },
  {
    rule: '-ble → -ble',
    ...
    words: [
      {en:'possible',    es:'posible',      art:'', zh:'可能的'},
      {en:'terrible',    es:'terrible',     art:'', zh:'可怕的'},
      {en:'incredible',  es:'increíble',    art:'', zh:'難以置信的'},
      {en:'responsible', es:'responsable',  art:'', zh:'負責任的'},
      {en:'flexible',    es:'flexible',     art:'', zh:'靈活的'},
    ]
  },
  {
    rule: '-or → -or / -ora（職業）',
    ...
    words: [
      {en:'doctor',    es:'doctor',    art:'el/la', zh:'醫生（女：doctora）'},
      {en:'actor',     es:'actor',     art:'el',    zh:'演員（女例外：actriz）'},
      {en:'professor', es:'profesor',  art:'el/la', zh:'教授（女：profesora）'},
      {en:'director',  es:'director',  art:'el/la', zh:'導演（女：directora）'},
      {en:'inspector', es:'inspector', art:'el/la', zh:'督察（女：inspectora）'},
    ]
  },
  {
    rule: '-y → -ia（名詞）',
    ...
    words: [
      {en:'history',   es:'historia',  art:'la', zh:'歷史'},
      {en:'memory',    es:'memoria',   art:'la', zh:'記憶'},
      {en:'pharmacy',  es:'farmacia',  art:'la', zh:'藥局'},
      {en:'victory',   es:'victoria',  art:'la', zh:'勝利'},
      {en:'biology',   es:'biología',  art:'la', zh:'生物學'},
      {en:'economy',   es:'economía',  art:'la', zh:'經濟'},
    ]
  },
  {
    rule: '-ar / -er / -ir（動詞字尾）',
    ...
    words: [
      {en:'visit',    es:'visitar',    art:'', zh:'拜訪'},
      {en:'practice', es:'practicar',  art:'', zh:'練習'},
      {en:'use',      es:'usar',       art:'', zh:'使用'},
      {en:'depend',   es:'depender',   art:'', zh:'依賴'},
      {en:'exist',    es:'existir',    art:'', zh:'存在'},
      {en:'permit',   es:'permitir',   art:'', zh:'允許'},
    ]
  },
];
