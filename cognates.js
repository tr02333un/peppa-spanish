...
const SUFFIX_PATTERNS = [
  {
    ...
    words: [
      {en:'nation',      es:'nación',       art:'la', zh:'國家',   ex:{es:'La nación entera celebra.',      zh:'整個國家都在慶祝。'}},
      {en:'action',      es:'acción',       art:'la', zh:'行動',   ex:{es:'¡En acción!',                   zh:'行動！'}},
      {en:'emotion',     es:'emoción',      art:'la', zh:'情緒',   ex:{es:'Es una emoción muy fuerte.',     zh:'這是非常強烈的情緒。'}},
      {en:'information', es:'información',  art:'la', zh:'資訊',   ex:{es:'Necesito más información.',      zh:'我需要更多資訊。'}},
      {en:'education',   es:'educación',    art:'la', zh:'教育',   ex:{es:'La educación es importante.',   zh:'教育很重要。'}},
      {en:'situation',   es:'situación',    art:'la', zh:'情況',   ex:{es:'Es una situación difícil.',     zh:'這是個困難的情況。'}},
    ]
  },
  {
    rule: '-ty → -dad',
    ...
    words: [
      {en:'city',        es:'ciudad',       art:'la', zh:'城市',   ex:{es:'La ciudad es muy grande.',      zh:'這個城市很大。'}},
      {en:'reality',     es:'realidad',     art:'la', zh:'現實',   ex:{es:'En la realidad es diferente.',  zh:'現實中不一樣。'}},
      {en:'quality',     es:'calidad',      art:'la', zh:'品質',   ex:{es:'Es de muy buena calidad.',      zh:'品質非常好。'}},
      {en:'university',  es:'universidad',  art:'la', zh:'大學',   ex:{es:'Voy a la universidad.',         zh:'我去大學。'}},
      {en:'society',     es:'sociedad',     art:'la', zh:'社會',   ex:{es:'La sociedad cambia rápido.',    zh:'社會變化很快。'}},
      {en:'liberty',     es:'libertad',     art:'la', zh:'自由',   ex:{es:'La libertad es un derecho.',    zh:'自由是一種權利。'}},
    ]
  },
  {
    rule: '-ce / -cy → -cia / -ncia',
    ...
    words: [
      {en:'patience',    es:'paciencia',    art:'la', zh:'耐心',   ex:{es:'Hay que tener paciencia.',      zh:'要有耐心。'}},
      {en:'experience',  es:'experiencia',  art:'la', zh:'經驗',   ex:{es:'Tiene mucha experiencia.',      zh:'她很有經驗。'}},
      {en:'distance',    es:'distancia',    art:'la', zh:'距離',   ex:{es:'¿Cuál es la distancia?',        zh:'距離是多少？'}},
      {en:'importance',  es:'importancia',  art:'la', zh:'重要性', ex:{es:'Tiene mucha importancia.',      zh:'這非常重要。'}},
      {en:'difference',  es:'diferencia',   art:'la', zh:'差異',   ex:{es:'¿Cuál es la diferencia?',      zh:'差異在哪裡？'}},
    ]
  },
  {
    ...
    words: [
      {en:'moment',     es:'momento',      art:'el', zh:'時刻',   ex:{es:'Es el momento perfecto.',        zh:'這是完美的時刻。'}},
      {en:'movement',   es:'movimiento',   art:'el', zh:'動作',   ex:{es:'Haz el movimiento lento.',      zh:'動作慢一點做。'}},
      {en:'sentiment',  es:'sentimiento',  art:'el', zh:'情感',   ex:{es:'Es un sentimiento bonito.',     zh:'這是個美好的情感。'}},
      {en:'instrument', es:'instrumento',  art:'el', zh:'樂器',   ex:{es:'Toca el instrumento bien.',     zh:'樂器彈得很好。'}},
      {en:'argument',   es:'argumento',    art:'el', zh:'論點',   ex:{es:'Es un buen argumento.',         zh:'這是個好論點。'}},
    ]
  },
  {
    rule: '-ble → -ble',
    ...
    words: [
      {en:'possible',    es:'posible',      art:'', zh:'可能的',     ex:{es:'Todo es posible.',              zh:'一切都是可能的。'}},
      {en:'terrible',    es:'terrible',     art:'', zh:'可怕的',     ex:{es:'¡Es terrible!',                zh:'太可怕了！'}},
      {en:'incredible',  es:'increíble',    art:'', zh:'難以置信的', ex:{es:'Es increíble.',                zh:'難以置信。'}},
      {en:'responsible', es:'responsable',  art:'', zh:'負責任的',   ex:{es:'Sé responsable.',              zh:'要負責任。'}},
      {en:'flexible',    es:'flexible',     art:'', zh:'靈活的',     ex:{es:'Hay que ser flexible.',        zh:'要靈活。'}},
    ]
  },
  {
    rule: '-or → -or / -ora（職業）',
    ...
    words: [
      {en:'doctor',    es:'doctor',    art:'el/la', zh:'醫生',   ex:{es:'El doctor es muy bueno.',       zh:'這位醫生很厲害。'}},
      {en:'actor',     es:'actor',     art:'el',    zh:'演員',   ex:{es:'Es un actor famoso.',           zh:'他是知名演員。'}},
      {en:'professor', es:'profesor',  art:'el/la', zh:'教授',   ex:{es:'La profesora explica bien.',   zh:'老師解釋得很清楚。'}},
      {en:'director',  es:'director',  art:'el/la', zh:'導演',   ex:{es:'El director ganó un premio.',  zh:'導演贏得了獎項。'}},
      {en:'inspector', es:'inspector', art:'el/la', zh:'督察',   ex:{es:'El inspector revisa todo.',    zh:'督察檢查一切。'}},
    ]
  },
  {
    rule: '-y → -ia（名詞）',
    ...
    words: [
      {en:'history',   es:'historia',  art:'la', zh:'歷史',   ex:{es:'Me gusta la historia.',          zh:'我喜歡歷史。'}},
      {en:'memory',    es:'memoria',   art:'la', zh:'記憶',   ex:{es:'Tiene buena memoria.',           zh:'她記憶力很好。'}},
      {en:'pharmacy',  es:'farmacia',  art:'la', zh:'藥局',   ex:{es:'Voy a la farmacia.',             zh:'我去藥局。'}},
      {en:'victory',   es:'victoria',  art:'la', zh:'勝利',   ex:{es:'¡Es la victoria!',              zh:'是勝利！'}},
      {en:'biology',   es:'biología',  art:'la', zh:'生物學', ex:{es:'Estudio biología.',              zh:'我念生物學。'}},
      {en:'economy',   es:'economía',  art:'la', zh:'經濟',   ex:{es:'La economía crece.',             zh:'經濟在成長。'}},
    ]
  },
  {
    rule: '-ar / -er / -ir（動詞字尾）',
    ...
    words: [
      {en:'visit',    es:'visitar',    art:'', zh:'拜訪', ex:{es:'Vamos a visitar a la abuela.',    zh:'我們去探望奶奶。'}},
      {en:'practice', es:'practicar',  art:'', zh:'練習', ex:{es:'Hay que practicar cada día.',     zh:'每天都要練習。'}},
      {en:'use',      es:'usar',       art:'', zh:'使用', ex:{es:'¿Puedo usar esto?',              zh:'我可以用這個嗎？'}},
      {en:'depend',   es:'depender',   art:'', zh:'依賴', ex:{es:'Depende de ti.',                 zh:'取決於你。'}},
      {en:'exist',    es:'existir',    art:'', zh:'存在', ex:{es:'El amor existe.',                zh:'愛是存在的。'}},
      {en:'permit',   es:'permitir',   art:'', zh:'允許', ex:{es:'No se permite entrar.',          zh:'不允許進入。'}},
    ]
  },
];
